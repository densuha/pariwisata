         ...
         <section class="content">
            <div class="card">
               <div class="card-header">
                  ...
                  <a href="tambah.php?page=kategori" class="btn btn-primary 
                        ...
                        ?>
                           <tr>
                              ...
                              <td class="text-center">
                                 <a href="edit.php?id=<?=
                                                      $data['id']; ?>&page=kategori" class="btn btn-warning">Edit</a>
                                 <a href="proses_hapus.php?id=<?=
                                                               $data['id']; ?>&page=kategori" class="btn btndanger">Hapus</a>
                              </td>
                           </tr>
                        <?php }
