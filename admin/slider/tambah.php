          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php?page=slider">Home</a></li>
                <li class="breadcrumb-item 
active">Tambah Data Slider</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <section class="content">
          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                <label>Nama Judul Slider</label>
                <input type="text" name="judul_post" class="form-control" placeholder="Masukan Judul Slider" required>
        ...
        <div class="card-footer">
          ...
          <a href="index.php?page=slider" type="button" class="btn 
